...
function LayoutContent({ children }) {
  ...
  return (
    <>
      <nav className="bg-[#0F248A] px-6 lg:px-14 py-2 ml-5 mr-5 lg:mr-[55px] lg:ml-[80px] mt-4 rounded-full">
        ...
        {isOpen && (
          <div
            className={`lg:hidden absolute top-0 left-0 right-0 bg-[#0F248A] bg-opacity-90 z-50 p-4 border rounded-3xl my-4 mx-4 transition-all duration-500 ease-in-out transform ${
